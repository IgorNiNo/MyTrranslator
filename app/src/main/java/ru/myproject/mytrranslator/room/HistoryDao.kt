package ru.myproject.mytrranslator.room

import androidx.room.*

// Построение методов должно быть вам знакомо. Единственное, чему стоит уделить внимание - ключевое слово suspend,
// которое намекает, что все запросы в БД будут асинхронными (корутины поддерживаются в Room изначально)
@Dao
